...
public class ReaderTest {
    ...
    public void creatingAnInstance_ShouldReturnAnInstance()
        ...
        Reader instance = Reader.getFactory().createArtefact(mock(Command.class));
    ...
    public void getInstance_ShouldUseTheFactory()
        ...
        when(mockedFactory.createArtefact(any(Command.class))).thenReturn(mockedReader);
        Factory.setInstance(Reader.class, mockedFactory);

        // when: getInstance() is called
        Reader reader = Reader.getFactory().createArtefact(mock(Command.class));
